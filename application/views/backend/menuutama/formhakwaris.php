    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form action="<?= base_url('admin/Menuutama/tambah_ahli_waris') ?>" method="POST" enctype="multipart/form-data">
...
<script>
    ...
    $(document).ready(function() {
        $.ajax({
            type: 'GET',
            url: '<?php echo base_url(); ?>admin/Menuutama/getKodeWaris',
            beforeSend: function() {
                $('.loading').show();
            },
