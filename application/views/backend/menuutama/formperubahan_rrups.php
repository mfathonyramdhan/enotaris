        ...
        <div class="container-fluid">
            ...
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">Formulir Permohonan Perubahan Risalah Rapat Umum Pemegang Saham</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form action="<?= base_url('admin/Menuutama/tambah_rrups') ?>" method="POST" enctype="multipart/form-data">
