        ...
        <div class="container-fluid">
            ...
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">Formulir Edit Permohonan Pembuatan APHT (Akta Pemberian Hak Tanggungan)</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form action="<?= base_url('user/Menuutama/update_apht') ?>" method="POST" enctype="multipart/form-data">
