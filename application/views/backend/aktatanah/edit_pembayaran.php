        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <h4>Lakukan Pembayaran Sebesar :</h4><h4 class="bg bg-warning" style="border-radius: 5%; padding:5px; margin-left:10px;">Rp. <?= $pembayaran['biaya'] ?></h4>
                        </div>
                        <div class="row">
                            <h4>Ke Rekening : </h4>
                        </div>
                        ...
                        <form action="<?= base_url('user/Menuutama/update_pembayaran_aktaT') ?>" method="POST" enctype="multipart/form-data">
                            <div class="row">
